 ...
 * Fecha: 12/08/2018
 *
 * Ejercicio 4: Contadores Binarios
 *
 * Comenzaremos implementando dos tareas de las cuales una deberá leer el
 * tiempo de pulsación de un botón, mediante antirrebote. Al completar la
 * lectura, una segunda tarea, deberá destellar un led en señal de recepción.
 *
 */
